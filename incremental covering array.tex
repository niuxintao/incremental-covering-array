...
There are several observations that can be made:
 ...
 \begin{enumerate}
 \item  Approach \emph{bottom-up} performs well at the reaming at, while Approach B performs well at subjects with degree
 \item  Approach C performs well at degree ,  Approach D preforms well at degree (there are 5 in 6 better than the strategy)
 \item  Approach and Approach is similar, .
 %\item  We apply our approach on testing an industrial software and compare the performance between the traditional approach with ours.
 \item Approach and Approach varies.
 \item Approach A and B performs well at subjects with parameters number big.
